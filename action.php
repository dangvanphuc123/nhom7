			...
			<form method="post" action="login_form.php">
				...
				if (!isset($_SESSION["uid"])) {
					echo '
							...
							<a href="" data-toggle="modal" data-target="#Modal_register" class="btn btn-success">Mua hàng</a></td>
								</tr>
							</tfoot>
					...
					echo '
						...
						<form action="checkout.php" method="post">
							...
							<input type="hidden" name="business" value="nhom7@gmail.com">
							...
							echo   
								'<input type="hidden" name="return" value="http://localhost/myfiles/public_html/payment_success.php"/>
									...
									<input type="submit" id="submit" name="login_user_with_product" name="submit" class="btn btn-success" value="Mua hàng">
									</form></td>
